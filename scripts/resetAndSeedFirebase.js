...
const schemas = {
  ...
  feeStructures: ['name', 'classKey', 'academicYear', 'admissionFee', 'tuitionFee', 'libraryFee', 'labFee', 'transportFee', 'totalAmount', 'dueDate', 'status', 'courseCode', 'courseName', 'feeYearLabel', 'courseTotalAmount', 'extraChargesNote', 'seedSource'],
  feeAssignments: ['feeStructureId', 'studentRecordId', 'studentId', 'studentName', 'classKey', 'academicYear', 'courseCode', 'courseName', 'admissionFee', 'tuitionFee', 'libraryFee', 'labFee', 'transportFee', 'totalAmount', 'paidAmount', 'adjustmentAmount', 'dueAmount', 'dueDate', 'status', 'feeYearLabel', 'seedSource'],
